...
def fix_swallowed(path):
    """Fixes swallowed issues in a file by applying a regex substitution.

    Only writes to the file if the substitution results in a change.

    Args:
        path (str): The path to the file to fix.
    """
